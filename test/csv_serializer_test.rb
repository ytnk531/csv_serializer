...
class CsvSerializerTest < ActiveSupport::TestCase
  ...
  test 'it outputs csv' do
    Person.create!(id: 1, name: 'sample1', tall: 128, weight: 34, created_at: '2020-1-1 10:02:39', updated_at: '2020-1-1 11:02:39',)
    Person.create!(id: 2, name: 'sample2', tall: 130, weight: 32, created_at: '2020-1-1 12:02:39', updated_at: '2020-1-1 14:02:39',)
